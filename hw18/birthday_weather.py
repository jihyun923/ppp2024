    ...
    with open(filename, encoding="UTF-8-sig") as f:
        ...
        for line in lines[8:]:
            ...
            if month == 9 and day == 23:
                ...
                avg_list.append(avg)
    return tmax_list, tmin_list, avg_list, dates

def main():
    filename = "ta_20240528160433.csv"
    ...
    tmax_list, tmin_list, avg_list, dates = weather(filename)

    plt.plot(dates, tmax_list, color = 'r', label = '평균최고기온')
    plt.plot(dates, tmin_list, color = 'b', label = "평균최저기온")
    plt.plot(dates, avg_list, color = 'g', label = "평균기온")
